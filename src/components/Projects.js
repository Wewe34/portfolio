    ...
    render () {
        return (
            <div id="projects-container">
                ...
                <div className="projimg">
                    ...
                    <div className="project-info">
                        ...
                        <p>Multi-user, pixel art editor used to create pixel art and
                            animations. Try your hand at it and save as a gif. (Desktop Only)</p>
                ...
                <div className="projects">
                <div className="projimg">
                    <a href="https://cassandra-terry.herokuapp.com"><img className="project-img" src="/images/proo.png" alt="site-pic"/></a>
                </div>
                    <div className="project-info">
